...
namespace WindowsFormsApp1
{
    public partial class Main_form : Form
    {
        ...
        private void task2ToolStripMenuItem2_Click(object sender, EventArgs e)
        {
            Task9 task9=new Task9();
            task9.ShowDialog();
        }

        private void task2ToolStripMenuItem3_Click(object sender, EventArgs e)
        {
            Task10 task10=new Task10();
            task10.ShowDialog();
        }

        private void task2ToolStripMenuItem4_Click(object sender, EventArgs e)
        {
